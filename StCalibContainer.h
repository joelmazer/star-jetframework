#ifndef StCalibContainer_H
#define StCalibContainer_H

// adapted from the ALIROOT class StAODBContainer
...
//
  static const char*   GetCalibPath();
 private:
