 ...
 * Default constructor
 */
StJetShapeProperties::StJetShapeProperties():
 ...
 */
StJetShapeProperties::StJetShapeProperties(const StJetShapeProperties &jet):
 ...
 * @param[in] jet Const reference to copy the content from
 */
StJetShapeProperties& StJetShapeProperties::operator=(const StJetShapeProperties &jet)
{
  fJetShapeMassFirstDer  = jet.fJetShapeMassFirstDer;
  fJetShapeMassSecondDer = jet.fJetShapeMassSecondDer;
  fJetShapeMassFirstSub  = jet.fJetShapeMassFirstSub;
 ...
 */
void StJetShapeProperties::PrintGR() const
{
