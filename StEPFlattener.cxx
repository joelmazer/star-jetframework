...
ClassImp(StEPFlattener)

//____________________________________________________________________________
StEPFlattener::StEPFlattener() :
  TNamed(),
  fNCentrBins(0), 
  fNHarmonics(0),
  fNparam(0),
...
//____________________________________________________________________________
StEPFlattener::StEPFlattener(const char * name,Int_t v3) :
...
//____________________________________________________________________________
StEPFlattener::StEPFlattener(const StEPFlattener & fl):
...
//____________________________________________________________________________
StEPFlattener & StEPFlattener::operator = (const StEPFlattener & fl)
{
  if(this== &fl)
    return *this ;
  SetName(fl.GetName()) ;
...
//____________________________________________________________________________
Double_t StEPFlattener::MakeFlat(Double_t oldPhi,Double_t centrality)const
{
...
//____________________________________________________________________________
void StEPFlattener::SetParameterization(TH2 * h){
